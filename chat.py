...
class Chat(ttk.Frame):
    def __init__(self, container, background, *args, **kwargs):
        ...
        self.message_input = tk.Text(input_frame, height=2)
    ...
    def get_messages(self):
        ...
        self.message_window.update_message_widgets(messages, message_labels, self.user)
        self.message_window.yview_moveto(1.0)
        self.after(50, lambda: self.get_messages())